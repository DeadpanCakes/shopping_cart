  ...
  return (
    <div style={{ marginBottom: 80 }}>
      ...
      <main style={mainStyle}>
        ...
        >
          <div style={{ backgroundColor: "#f0f8ff95", padding: 15 }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-start" }}>
              <ContactForm />
              <p style={{ flex: "1", textAlign: "center", padding: 10, fontSize: '1.3em' }}>
        ...
        >
          <div style={{ backgroundColor: "#f0f8ff95", padding: 15 }}>
            ...
            <p style={{fontSize: '1.3em'}}>
              ...
              Participate in exclusive deals and giveaways!
            </p>
          </div>
        </section>
        <div
        ...
        >
          <img alt="Our nursery" src={nursery2Img} style={{ maxWidth: 900 }} />
          <h2
            style={{
              position: "absolute",
              left: "10%",
        ...
        <section style={{ ...sectionStyle, alignSelf: "end", display: "flex", backgroundImage: `url(${nurseryImg})` }}>
          <div style={{ backgroundColor: "#f0f8ff95", padding: 15 }}>
            <div style={{ flex: 2 }}>
              <h1>Visit Us</h1>
              <p style={{fontSize: '1.3em'}}>
            ...
            >
              ...
              <p style={{fontSize: '1.3em'}}>475 Konopelski Harbors, San Diego, Ca 94516</p>
            </div>
          </div>
        </section>
      </main>
