...
const stock = (() => {
  const items = [
    ...
    succulentFactory(
      ...
      'Echeveria "Lola"',
      4,
      ["Pastel", "Multicolor", "Drought-Resistant", "Showy Bloom"],
      images.lola
    ),
    succulentFactory(
      3,
      ...
      6,
      ["Pastel", "Drought-Resistant", "Showy Bloom"],
      images.raspberry
    ),
    succulentFactory(
      4,
      'Sedum "Burrito"',
      4,
      ["Drought-Resistant", "Easy to Propagate", "Non-Toxic", "Hanging"],
      images.burrito
    ),
    succulentFactory(
      5,
      ...
      4,
      ["Drought-Resistant", "Fast Grower", "Easy To Propagate", "Hanging"],
      images.fishhook
    ),
    succulentFactory(
      6,
    ...
    tillandsiaFactory(
      ...
      "Ionantha Guatemala",
      1,
      ["Slow Grower", "Changes Color", "Clumps Quickly"],
      images.guat
    ),
    tillandsiaFactory(
      8,
      "Xerographica",
      10,
      ["Slow Grower", "Long-Lived", "Drought-Resistant"],
      images.xero
    ),
